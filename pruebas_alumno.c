...
void crear_lista_vacia() {
  ...
  pa2m_afirmar(
      lista_tamanio(lista) == 0 && lista_vacia(lista),
      "Se prueba crear una lista valida y verificar que empiece vacia.");
...
void insertar_final_lista_vacia() {
  ...
  pa2m_afirmar(lista_insertar(lista, &elemento) == lista &&
                   lista_vacia(lista) == false && lista_tamanio(lista) == 1,
...
void verificar_posicion_insertar_final() {
  ...
  pa2m_afirmar(lista_insertar(lista, &elemento5) == lista &&
                   lista_vacia(lista) == false &&
                   lista_elemento_en_posicion(lista, 5) != NULL,
               "Se prueba insertar al final en una lista con elementos y se "
               "verifica que está en la posición correcta");
...
void insertar_x_posicion_lista_elementos() {
  ...
  pa2m_afirmar(lista_vacia(lista) == false && *elemento == 20,
               "Se prueba insertar en cualquier posición en una lista con "
               "elementos y se verifica que está en la posición correcta");
...
void insertar_posicion_inexistente() {
  ...
  pa2m_afirmar(lista_vacia(lista) == false && *ultimo_elemento == 20 &&
                   lista_elemento_en_posicion(lista, posicion_deseada) == NULL,
               "Se prueba insertar en una posición inexistente en la lista, y "
               "se verifica que la posición de ese elemento es la última");
...
void quitar_de_lista_nula() {
  ...
  pa2m_afirmar(elemento == NULL,
               "No se puede quitar un elemento de una lista nula");
}
...
void quitar_ultimo_elemento() {
  ...
  pa2m_afirmar(
      *(int *)elemento_quitado == elem3 && *(int *)lista_ultimo(lista) == elem2,
...
void quitar_de_posicion_en_lista_nula() {
  ...
  pa2m_afirmar(
      elemento == NULL,
      "No se puede quitar un elemento de cualquier posición en una lista nula");
}
...
void quitar_de_posicion_en_lista_vacia() {
  ...
  pa2m_afirmar(elemento == NULL, "No se puede quitar un elemento de cualquier "
...
void quitar_elemento_de_posicion_en_lista_con_elementos() {
  ...
  pa2m_afirmar(*(int *)elemento_quitado == elem2,
               "Se prueba quitar un elemento de cualquier posición de una "
               "lista con elementos");
...
void quitar_multiples_elementos_de_lista() {
  ...
  pa2m_afirmar(*(int *)elemento_quitado1 == elem1 &&
                   *(int *)elemento_quitado2 == elem4 &&
                   *(int *)lista_ultimo(lista) != elem4 &&
                   *(int *)lista_elemento_en_posicion(lista, 0) != elem1,
...
void quitar_elemento_posicion_inexistente() {
  ...
  pa2m_afirmar(*(int *)elemento_quitado == elem3 &&
                   lista_ultimo(lista) != &elem3,
               "Se prueba quitar de una posición inexistente en la lista y el "
               "último elemento ya no está en la lista");
...
void quitar_elemento_null() {
  ...
  pa2m_afirmar(elemento_quitado == NULL &&
                   lista_elemento_en_posicion(lista, posicion) != NULL,
...
void obtener_elemento_lista_vacia() {
  ...
  void *elemento = lista_elemento_en_posicion(lista, 0);
  pa2m_afirmar(elemento == NULL,
               "No se puede obtener un elemento de una lista vacía");
...
void obtener_elemento_posicion_inexistente() {
  ...
  void *elemento = lista_elemento_en_posicion(lista, 5);
  pa2m_afirmar(elemento == NULL,
               "No se puede obtener un elemento de una posición inexistente");
...
void obtener_elemento_posicion_existente() {
  ...
  void *elemento = lista_elemento_en_posicion(lista, 0);
  pa2m_afirmar(*(int *)elemento == elem1,
               "Se obtuvo correctamente el elemento de una posición existente");
...
void obtener_cantidad_elementos_lista_vacia() {
  lista_t *lista = lista_crear();
