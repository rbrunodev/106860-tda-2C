...
void verificar_posicion_insertar_final()
{
	...
	pa2m_afirmar(
		lista_insertar(lista, &elemento5) == lista &&
			lista_vacia(lista) == false &&
...
void insertar_x_posicion_lista_elementos()
{
	...
	int *elemento =
		(int *)lista_elemento_en_posicion(lista, posicion_deseada);

	pa2m_afirmar(
		lista_vacia(lista) == false && *elemento == 20,
...
void insertar_posicion_inexistente()
{
	...
	pa2m_afirmar(
		lista_vacia(lista) == false && *ultimo_elemento == 20 &&
			lista_elemento_en_posicion(lista, posicion_deseada) ==
				NULL,
...
void quitar_de_posicion_en_lista_vacia()
{
	...
	pa2m_afirmar(elemento == NULL,
		     "No se puede quitar un elemento de cualquier "
...
void quitar_multiples_elementos_de_lista()
{
	...
	pa2m_afirmar(*(int *)elemento_quitado1 == elem1 &&
			     ...
			     *(int *)lista_elemento_en_posicion(lista, 0) !=
				     elem1,
