...
void probar_operaciones_lista() {
  ...
  printf(
      "Imprimo TODOS LOS ELEMENTOS DE LA LISTA usando el iterador externo: \n");
  lista_iterador_t *it = NULL;

  for (it = lista_iterador_crear(lista); lista_iterador_tiene_siguiente(it);
  ...
  printf(
      "Imprimo TODOS LOS ELEMENTOS DE LA LISTA usando el iterador interno: \n");
